...
(() => {
  ...
  function appendChild(tag, html, parent = document, attributes) {
  ...
  function createFooter() {
    ...
    for (const [platform2, link] of Object.entries(SOCMED))
      appendChild(
        "a",
        `<img src="https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/${platform2}.svg" alt="${platform2}" width="24" height="24">`,
        socMedElem,
